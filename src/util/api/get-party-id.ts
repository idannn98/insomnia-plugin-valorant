...
export async function getPartyId(shard: string, region: string, puuid: string, clientVersion: string, clientPlatform: string, accessToken: string, entitlement: string) {
